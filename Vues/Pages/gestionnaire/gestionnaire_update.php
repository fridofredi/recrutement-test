            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="view view-cascade py-3 gradient-card-header">
                        <p class="lead">
                            <span class="badge info-color-dark p-2">Modifier un gestionnaire</span>
                        </p>
                    </div>
                    <!--/Panel Header-->
                    ...
                    <div class="card-body">
                        ...
                        <form action='index.php?page=Gestionnaire/upgrade' method='post' id='datatable'
                              class='form-element'>
                            <?= $CSRF() ?>
                            <div class="form-row">
                                    ...
                                    <div class='col-6'>
                                        <div class='md-form'>
                                            ...
                                            <input class='form-control' name='nom' id='nom' type='text'
                                                   value='<?= $table->getNom() ?>' placeholder='NOM'>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-6'>
                                        <div class='md-form'>
                                            ...
                                            <input class='form-control' name='prenoms' id='prenoms' type='text'
                                                   value='<?= $table->getPrenoms() ?>' placeholder='PRENOMS'>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-6'>
                                        <div class='md-form'>
                                            ...
                                            <input class='form-control' name='username' id='username' type='text'
                                                   value='<?= $table->getUsername() ?>' placeholder='USERNAME'>
                                        </div>
                                    </div>
